    ...
    return(
        <div className="w-full h-screen p-20 flex">
            ...
            <div className="Heading">
                <h1 className="uppercase text-[6vw] tracking-tighter font-semibold leading-none font-[Neue_Montreal]">Eye-</h1>
                <h1 className="uppercase text-[6vw] tracking-tighter leading-none font-semibold font-[Neue_Montreal]">Opening</h1>
            </div>
            ...
            <div className="w-1/2">
            <h1 className="uppercase text-[6vw] tracking-tighter leading-none font-semibold font-[Neue_Montreal]">Presentations</h1>
