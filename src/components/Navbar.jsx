...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    return(
        ...
        <div
        className={`fixed z-[990] w-full px-20 py-8 font-["NeueMontreal"] flex justify-between items-end ${
            ...
            <div className='links flex gap-10'>

                {
                    ["Services", "Our work", "About us", "Insights", "Contact us"].map((items,index) => (
                        <a key={index} className={`text-lg font-medium font-light ${index === 4 && "ml-32"}`} >{items}</a>
                     ) )
                }
